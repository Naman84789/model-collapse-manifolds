...
\textbf{profile shape}: the measured $\hat\kappa(t)$ sags $\approx0.5$--$0.7$ below its
own ceiling inside the deficit band, worth $+0.7\,\sigsq$ at the data width. Beyond it
