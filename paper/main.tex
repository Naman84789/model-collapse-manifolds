...
from $3.47$ to $3.30$, so width and skew together account for roughly half of the ring's
$3.6\to3.0$ gap and we do not claim to have closed the budget. The methodological point
survives the incompleteness, and is the one we would ask a reader to take: $\kb$ is not a
...
\emph{Where the comparison stops working (\emph{we observe}).} The margin narrows
monotonically as the tube fattens: $77$--$85\%$ of the measured floor at $\sigma=0.05$,
$90$--$97\%$ at $\sigma=0.10$, and $97$--$103\%$ at $\sigma=0.13$, where the envelope
exceeds the measured floor in three of six seeds. We report this rather than trim the
range. It is not evidence against Theorem~\ref{thm:floor}, whose chain we verify
...
of six seeds at
$\sigma=0.13$, where curvature is no longer negligible against the flat-tube
idealisation; we take $\sigma\lesssim0.10$ as the validated range for that comparison. Every
