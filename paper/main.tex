...
\item \textbf{Falsifiable empirics}, each targeting a named claim:
  ...
  \item \emph{Floor anatomy \& intervention}: read at the ceiling the theorem
    ...
    and the comparison fails at $\sigma=0.13$, where the flat-tube idealisation expires;
...
$\rho$ grows, which is what the theorem predicts. We record the curvature term we checked
...
of the measured floor at $\sigma=0.05$ and $90$--$97\%$ at $\sigma=0.10$ but fails in three
of six seeds at
$\sigma=0.13$ by at most $3.4\%$, inside the relative error term $O(\sigsq/
ho^2)=4.2\%$
that Theorem~
ef{thm:floor} carries at that width; no validity range is restricted. Every
