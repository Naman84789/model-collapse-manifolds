...
\emph{larger} bound: at $\sigma=0.05$ and this section's truncation $t_0=10^{-4}$,
$\kb=3.01$ rather than $3.59$, and an envelope of $5.5\,\sigsq$ rather than
$3.9\,\sigsq$ (Figure~\ref{fig:floorlaw}), against a measured single-pass floor of
$7.9\,\sigsq$. Across the five widths the envelope accounts for $69$ to $74\%$ of the
measured floor, where the forward-process reading accounted for $47$ to $56\%$; no width
is falsified and the tightest margin is $26\%$. The exact-score control reproduces
$\gamma^2(t_0)$ to all displayed digits.
