...
$t=0.1$ to $-1.02$ at $t=5\times10^{-3}$. Skewness is the sharpest discriminator we
found: essentially zero on flat normal coordinates and order one on curved ones. Injecting
...
\emph{The probe gap, in full (\emph{we observe}).} The margin narrows
