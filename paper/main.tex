...
\emph{The gap is curvature, not saturation (\emph{we observe}).} The natural explanation
--- that the sampler's ensemble is fatter than $p_t$ and so probes the response into its
flattening tails --- is wrong, and the geometries of \S\ref{sec:experiments} refute it.
