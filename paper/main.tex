...
\emph{larger} bound: at $\sigma=0.05$, $\kb=3.01$ rather than $3.59$, and an envelope of
$5.5\,\sigsq$ rather than $3.9\,\sigsq$, against a measured single-pass floor of
...
rising monotonically in $\sigma$. The degradation law is not merely rescaled but
\emph{flatter}, $\kb(w)\approx3.65-8.33\sqrt w$ against $4.46-11.42\sqrt w$ (max residual
$0.033$ on both), so no single factor converts one into the other. Propagated through the
