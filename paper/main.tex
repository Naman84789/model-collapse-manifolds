...
returns a systematically larger ceiling, because the sampler's ensemble is fatter than
$p_t$ once excess accumulates and so probes the S-shaped response into its flattening
tails. Measured on the same networks across five tube widths
(\texttt{kbar\_sampler\_law.py}; $\sigma=0.03$ to $0.13$), the sampler-law ceiling is
$0.83$ to $0.87$ of the forward-process one, monotone in $\sigma$ and without exception.
