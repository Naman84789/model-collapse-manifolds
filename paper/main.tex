...
$-0.496$. Sweeping $t$ at a fixed step $d\tau=10^{-4}$, the curvature term is reproduced to
a ratio of $0.993$, $0.992$ and $0.978$ at $t=0.5$, $0.2$ and $0.1$, where the term is
$-0.180$, $-0.063$ and $-0.031$. Below that the term falls under the estimator's own noise
--- the absolute discrepancy stays between $0.0005$ and $0.005$ down to $t=5\times10^{-3}$,
and is $0.013$ at $t=2\times10^{-3}$, while the term itself shrinks to $-0.005$ --- so we
claim the identity only where it is resolvable, and note that this is the same statement as
the correction being negligible at small $t$.
