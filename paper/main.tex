...
\]
so Theorem~\ref{thm:floor} holds verbatim with the coefficient shifted by $-L$. For a
sphere in $\R^D$ whose ensemble stays at radius $\ge a$, $L=(D-1)/a^2$.
\end{corollary}
...
Corollary~\ref{cor:curved} only for the assumption-light statement.
